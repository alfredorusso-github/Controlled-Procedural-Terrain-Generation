...
\begin{document}
    ...
    \begin{figure}[H]
        \centering     %%% not \center
        \subfigure[]{\includegraphics[width=60mm]{images/Overall/3/1}}
        \subfigure[]{\includegraphics[width=60mm]{images/Overall/3/2}}
        \subfigure[]{\includegraphics[width=60mm]{images/Overall/3/3}}
        \subfigure[]{\includegraphics[width=60mm]{images/Overall/3/4}}
    \end{figure}
